...
(function () {
  ...
  window.needShareButton = function (elem, options) {
    ...
    root.share = {
      ...
      "technorati": function technorati(el) {
        var myoptions = getOptions(el);
      ...
      "googlebookmarks": function googlebookmarks(el) {
        var myoptions = getOptions(el);
    ...
    root.popup = function (url) {
      ...
      left = width / 2 - popupWidth / 2 + dualScreenLeft,
          ...
          // show popup
      shareWindow = window.open(url, "targetWindow", "toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=" + popupWidth + ", height=" + popupHeight + ", top=" + top + ", left=" + left); // Puts focus on the newWindow
