...
!function (i, e) {
  ...
  var s = "0.7.9",
      ...
      k = "embedded",
      y = {
    extend: function extend(i, e) {
      for (var s in e) {
        -1 !== "browser cpu device engine os".indexOf(s) && e[s].length % 2 === 0 && (i[s] = e[s].concat(i[s]));
      }

      return i;
    },
    has: function has(i, e) {
    ...
    major: function major(i) {
      return _typeof(i) === w ? i.split(".")[0] : e;
    }
  },
      A = {
    rgx: function rgx() {
      for (var i, s, o, r, w, l, d, p = 0, c = arguments; p < c.length && !l;) {
        ...
        if (_typeof(i) === a) {
          ...
          for (r in m) {
            w = m[r], _typeof(w) === t ? i[w[0]] = e : i[w] = e;
          }
        }

        for (s = o = 0; s < u.length && !l;) {
          if (l = u[s++].exec(this.getUA())) for (r = 0; r < m.length; r++) {
            d = l[++o], w = m[r], _typeof(w) === t && w.length > 0 ? 2 == w.length ? i[w[0]] = _typeof(w[1]) == n ? w[1].call(this, d) : w[1] : 3 == w.length ? i[w[0]] = _typeof(w[1]) !== n || w[1].exec && w[1].test ? d ? d.replace(w[1], w[2]) : e : d ? w[1].call(this, d, w[2]) : e : 4 == w.length && (i[w[0]] = d ? w[3].call(this, d.replace(w[1], w[2])) : e) : i[w] = d ? d : e;
          }
        }
  ...
  T.VERSION = s, T.BROWSER = {
    ...
    NAME: p,
    VERSION: m
  }, (typeof exports === "undefined" ? "undefined" : _typeof(exports)) !== a ? ((typeof module === "undefined" ? "undefined" : _typeof(module)) !== a && module.exports && (exports = module.exports = T), exports.UAParser = T) : (typeof define === "undefined" ? "undefined" : _typeof(define)) === n && define.amd ? define(function () {
    return T;
  }) : i.UAParser = T;
