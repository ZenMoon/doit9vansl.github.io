    ...
    *********************/
    ...
    var Type = {
      ...
      isNodeList: function isNodeList(variable) {
        return _typeof(variable) === "object" && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(Object.prototype.toString.call(variable)) && variable.length !== undefined && (variable.length === 0 || _typeof(variable[0]) === "object" && variable[0].nodeType > 0);
      },
